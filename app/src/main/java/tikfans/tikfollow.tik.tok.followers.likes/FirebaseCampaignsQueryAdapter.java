...
import tikfans.tikfollow.tik.tok.followers.likes.subviewlike.LikeChiTietChienDichActivity;
import tikfans.tikfollow.tik.tok.followers.likes.model.LikeCampaign;
import tikfans.tikfollow.tik.tok.followers.likes.subviewlike.SubChiTietChienDichActivity;
...
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.CAMPAIGN_PATH_STRING_EXTRA;
...
//                        FirebaseUtil.getCampaignCurrentUser().child(mCampaignPaths.get(position).first).removeValue();
    ...
    public interface OnSetupViewListener {
        void onSetupView(tikfans.tikfollow.tik.tok.followers.likes.ChienDichViewHolder holder, SubCampaign subCampaign, LikeCampaign likeCampaign);
    }
}
