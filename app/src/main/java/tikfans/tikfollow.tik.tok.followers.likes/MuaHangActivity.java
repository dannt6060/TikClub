...
import tikfans.tikfollow.tik.tok.followers.likes.model.LogPurchase;
import tikfans.tikfollow.tik.tok.followers.likes.util.SecureDate;

import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_HUGE_PACKAGE;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_LARGE_PACKAGE;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_LARGE_PROMOTE_PACKAGE;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_MAX_PACKAGE;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_MAX_PROMOTE_PACKAGE;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_MINI_PACKAGE;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_MINI_PROMOTE_PACKAGE;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_SMALL_PACKAGE;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_VIP_YEARLY;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_VIP_THREE_MONTHS;
import static tikfans.tikfollow.tik.tok.followers.likes.util.AppUtil.SKU_VIP_MONTHLY;
