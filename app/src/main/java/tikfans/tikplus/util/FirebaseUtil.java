...
public class FirebaseUtil {
    ...
    public static String SUB_LIKED_REF = "subLiked";
    ...
    public static DatabaseReference getSubscribedListRef() {
        return getSubLikedCurrentUserRef().child(SUBSCRIBED_REF).child(SUBSCRIBED_LIST_REF);
    }

    public static DatabaseReference getUnSubscribedListRef() {
        return getSubLikedCurrentUserRef().child(REPORT_REF);
    }

    public static DatabaseReference getSubscribedCountRef() {
        return getSubLikedCurrentUserRef().child(SUBSCRIBED_REF).child(SUBSCRIBED_COUNT_REF);
    }

    public static DatabaseReference getSubscribedTodayRef() {
        return getSubLikedCurrentUserRef().child(SUBSCRIBED_REF).child(SUBSCRIBED_TODAY_REF);
    }

    public static DatabaseReference getOldLikedListRef() {
        return getCurrentUserRef().child(LIKED_REF).child(LIKED_LIST_REF);
    }

    public static DatabaseReference getLikedListRef() {
        return getSubLikedCurrentUserRef().child(LIKED_REF).child(LIKED_LIST_REF);
    }

    public static DatabaseReference getLikedCountRef() {
        return getSubLikedCurrentUserRef().child(LIKED_REF).child(LIKED_COUNT_REF);
    }

    public static DatabaseReference getLikedTodayRef() {
        return getSubLikedCurrentUserRef().child(LIKED_REF).child(LIKED_TODAY_REF);
    }

    public static DatabaseReference getReportSubRef(String uid) {
        return getSubLikedRef().child(uid).child(REPORT_REF);
    }
